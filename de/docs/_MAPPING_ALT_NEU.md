...
**Lese-Tipp:** Wenn du auf ein RFT_NN-Dokument verlinkt bist (z.B. von Zenodo-DOI 10.5281/zenodo.19259914 oder externer Diskussion), finde hier die aktuelle v3-Entsprechung.

---

## Mapping-Tabelle

### Klassisches RFT_NN → v3-Konsolidierung
...
| Neue Nummer | Pfad | Inhalt | Stand |
|---|---|---|---|
| RFT_v3_015 | `v3_konsolidierung/RFT_v3_015_Traegheit_Aequivalenz.md` | Trägheit + Äquivalenzprinzip (η_B ≈ 6×10⁻¹⁰) | Reviewed 2026-05-06 |
| RFT_v3_016 | `v3_konsolidierung/RFT_v3_016_Spin_Topologie.md` | Spin als 720°-Topologie, AP⊥Spin | Reviewed 2026-05-06 |
| RFT_v3_017 | `v3_konsolidierung/RFT_v3_017_Verschraenkung.md` | Topologische Identität, Bell-Theorem | Reviewed 2026-05-06 |
| RFT_v3_018 | `v3_konsolidierung/RFT_v3_018_Entropie_Signaltheorie.md` | γ-Dreifach-Verbindung, Dekohärenz | Reviewed 2026-05-06 |
| RFT_v3_019 | `v3_konsolidierung/RFT_v3_019_Supraleitung.md` | Cooper-Paar n=0, 45 THz | Reviewed 2026-05-06 |
| RFT_v3_020 | `v3_konsolidierung/RFT_v3_020_Taxonomie.md` | Synthesis-Dokument Stufe IV | Reviewed 2026-05-06 |

## Zusammenfassung

- **20+ alte Dokumente** durch v3-Konsolidierung abgelöst oder erweitert
- **6 neue v3-Dokumente** (v3_015–020) ohne altes 1-zu-1-Pendant — Synthesis aus mehreren Quellen
- **Phase A 2026-05-05** hat 4 unique Cache-Dokumente in `spezialisierung/` und `grundlagen/` gerettet (RFT_17 Cooper-Paare, RFT_38 Entropie, RFT_47 45 THz, RFT_44 Raumgitter-Thermo)
- **v3-Reihe ist kanonisch** ab Februar 2026

## Empfehlung für Reviewer

Wenn du auf ein altes RFT_NN-Dokument zitiert wirst, prüfe in obiger Tabelle die aktuelle v3-Entsprechung. Die alten Dokumente bleiben als historische Referenz erhalten — ihre Inhalte sind in der v3-Reihe konsolidiert + erweitert.

---

*Cross-Reference: [v3_konsolidierung/README.md](v3_konsolidierung/README.md) · [00_uebersicht/theorie_architektur.md](00_uebersicht/theorie_architektur.md) · [00_uebersicht/formel_chronologie.md](00_uebersicht/formel_chronologie.md)*
