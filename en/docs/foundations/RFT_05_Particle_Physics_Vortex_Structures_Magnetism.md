...
Table of Contents
    ...
    Introduction: Particles as Vortex Structures
    
    Mathematical Foundations of RFT
    
    Topological Classification of Particles
    
    Quark Confinement & Color Charge
    
    Lepton Family & Weak Interaction
    
    Experimental Validation & Tests
    
    Standard Model Correspondence
    
    New Particle Predictions
    
    Magnetism & Lattice Modulation
    
    Glossary of Particle Physics Terminology
